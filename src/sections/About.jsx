  ...
  return (
    <section className="w-full" id="About">
      <div className="wrapper relative">
        ...
        <p className="normal-case max-w-md text-xl font-semibold max-sm:text-base max-sm:text-center">
        ...
        <img
          className="w-[600px] h-[600px] absolute top-0 right-0 max-sm:hidden"
